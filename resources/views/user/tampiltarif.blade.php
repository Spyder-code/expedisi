        ...
        <div class="row">
          ...
          <div class="row">
            ...
            <form action="" class="p-5 bg-white">
                ...
                <div class="form-group">
                      <label for="exampleFormControlInput1">Berat Barang</label>
                    <input type="text" name="berat2" class="form-control" value="{{$Cekberat}}">
                    </div>
                </div>
                <div class="form-group">
                    <label for="exampleFormControlInput1">Satuan</label>
                    <input type="text" class="form-control" name="satuan2" readonly="" value="{{$Ceksatuan}}">
                </div>
                <div class="form-group">
                    <label for="exampleFormControlInput1">Ekspedisi</label>
                    <input type="text" class="form-control" name="expedisi2" readonly="" value="{{$Cekexpedisi}}">
                </div>
                <div class="form-group">
                      <label for="exampleFormControlInput1">Lokasi Tujuan</label>
                      <input type="text" class="form-control" name="tujuan2" readonly="" value="{{$Cektujuan}}">
                </div>
                <div class="form-group">
                    <label for="exampleFormControlInput1">Harga</label>
                    <input type="text" class="form-control" name="harga2" readonly="" value="{{$Cekharga}}">
              </div>
            </form>
        </div>
